...
$template->assign_vars(array(  
  ...
  'STR' => min(255,($baseSTR+$itemstats->STR())),
  'STA' => min(255,($baseSTA+$itemstats->STA())),
  'DEX' => min(255,($baseDEX+$itemstats->DEX())),
  'AGI' => min(255,($baseAGI+$itemstats->AGI())),
  'INT' => min(255,($baseINT+$itemstats->INT())),
  'WIS' => min(255,($baseWIS+$itemstats->WIS())),
  'CHA' => min(255,($baseCHA+$itemstats->CHA())),
