...
$language['FLAG_PoP_AD1'] = "(optional) You have defeated the prysmatic dragon, Aerin`Dar within the Plane of Valor."; 
$language['FLAG_PoP_AD2'] = "(optional) You have used the portal from the Plane of Valor to enter the Halls of Honor."; 
$language['FLAG_PoP_AD3'] = "(level 62) You are high enough level to zone into the Halls of Honor."; 
...
$language['FLAG_PoP_Askr3'] = "You have entered the Bastion of Thunder through the portal in the center of Plane of Storms."; 
...
$language['FLAG_PoP_Cipher'] = "You hailed Grand Librarian Maelin and completed the Cipher of Druzzil."; 
$language['FLAG_PoP_KoS'] = "You have killed The Keeper of Sorrows."; 
$language['FLAG_PoP_PoFire'] = "Plane of Fire"; 
$language['FLAG_PoP_MaelinInfo1'] = "You asked Grand Librarian about the Zek Brother's information."; 
...
$language['FLAG_PoP_PreSolRo'] = "Ask Miak the Searedsoul about the portal's destination."; 
$language['FLAG_PoP_SolRo'] = "You have defeated Solusek Ro within his own tower."; 
$language['FLAG_PoP_PoAirEarthWater'] = "Planes of Air, Earth and Water"; 
$language['FLAG_PoP_Agnarr'] = "You have defeated Agnarr, the Storm Lord and talked to Karana."; 
$language['FLAG_PoP_PreSaryrn'] = "You have said 'I will go' to Fahlia Shadyglade in the Plane of Tranquility"; 
$language['FLAG_PoP_MaelinLore'] = "You have asked Grand Librarian Maelin about Zebuxoruk's lore."; 
$language['FLAG_PoP_MaelinInfo2'] = "You have asked Grand Librarian Maelin for information about the Plane of Time."; 
...
$language['FLAG_PoP_Time'] = "You used Maelin's impressive machine to enter the Plane of Time."; 
